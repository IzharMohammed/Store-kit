...
//         const url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/api/trpc/public.product.getAll?input=${encodeURIComponent(
//           serialized
//         )}`;
...
//               value={searchInput}
//               onChange={(e) => {
//                 setSearchInput(e.target.value); // ✅ Update display immediately
//               }}
